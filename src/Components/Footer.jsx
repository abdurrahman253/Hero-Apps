...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-r from-[#632EE3]/10 via-[#9F62F2]/10 to-[#632EE3]/10 text-gray-800 border-t border-gray-300">
      ...
      <form className="space-y-3">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <input
            ...
            className="input input-bordered flex-1 py-2 focus:outline-none"
          />
          <button className="btn bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white hover:scale-105 transition-all duration-300">
            Subscribe
          </button>
        </div>
      </form>
