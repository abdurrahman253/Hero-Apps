...
const Navbar = () => {
    ...
    <div className="dropdown">
      ...
      <ul
        tabIndex={0}
        className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 space-y-3.5 shadow">
...
>
  {({ isActive }) => (
    <>
      ...
      <span
        className={`absolute left-0 -bottom-2 h-[3px] bg-gradient-to-r from-[#9F62F2] to-[#632EE3] transition-all duration-300 ${
